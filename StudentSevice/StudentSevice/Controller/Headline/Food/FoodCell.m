...
@property(nonatomic,retain)UIButton *openMapButton;
...
@synthesize openMapButton = _openMapButton;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.background addSubview:self.openMapButton];
...
-(void)layoutSubviews
{
    ...
    self.openMapButton.frame = CGRectMake(0, 0, 0, 0);
}
