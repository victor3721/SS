...
@property(nonatomic,retain)UIImageView *rentIV;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //
        //
        self.rentIV = [[UIImageView alloc]init];
        [self.background addSubview:self.rentIV];
...
-(void)layoutSubviews
{
    ...
    self.rentIV.frame = CGRectMake(0, 0, 0, 0);
}
