...
{
#warning already change
    self = [super initWithFrame:CGRectMake(0, -(kTotalViewHeight + scrollView.contentInset.top)+40.0, scrollView.frame.size.width, kTotalViewHeight)];
